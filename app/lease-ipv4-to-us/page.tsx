...
export default function LeasingIPv4ToUsPage() {
  return (
      ...
      <main className="pb-20">
        ...
        <section className="mx-auto mt-16 flex max-w-6xl flex-col gap-12 px-4 md:flex-row md:items-center lg:px-0">
          <div className="flex-1 space-y-4 text-sm leading-relaxed text-slate-600">
            ...
            <p>
              If you own address space that you are not using at full capacity, leasing it to us can provide a stable,
              recurring revenue stream. We take care of placement, subleasing, and operational management while you retain
              ownership of the resources.
            </p>
            <p>
              Our process defines clear responsibilities, routing policies, and reporting standards so that your ranges are
              used responsibly and remain compliant with registry expectations.
            </p>
            <p>
              You benefit from predictable income while we handle day-to-day allocation and support for end customers
              leasing the space from us.
            </p>
          </div>
              ...
              <div className="relative w-full max-w-md rounded-[40px] bg-white p-4 shadow-[0_24px_60px_rgba(15,23,42,0.18)]">
                <div className="overflow-hidden rounded-[32px] bg-slate-200">
                  <Image
                    ...
                    alt="Person holding a tablet with analytics charts"
                    width={900}
                    height={600}
          ...
          <div className="mt-12 space-y-10">
            <div className="relative flex justify-center">
              <div className="relative flex w-full max-w-4xl items-center rounded-full bg-white px-10 py-6 shadow-[0_10px_30px_rgba(15,23,42,0.06)]">
                ...
                <div className="ml-6 flex-1 text-left">
                  ...
                  <p className="mt-1 text-xs text-slate-600">We discuss lease terms, regions, and usage policies that suit your goals.</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative flex justify-center">
              <div className="relative flex w-full max-w-4xl flex-row-reverse items-center rounded-full bg-white px-10 py-6 shadow-[0_10px_30px_rgba(15,23,42,0.06)]">
                ...
                <div className="mr-6 flex-1 text-right">
                  ...
                  <p className="mt-1 text-xs text-slate-600">We sign an NDA and a preliminary lease framework to protect both parties.</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative flex justify-center">
              <div className="relative flex w-full max-w-4xl items-center rounded-full bg-white px-10 py-6 shadow-[0_10px_30px_rgba(15,23,42,0.06)]">
                ...
                <div className="ml-6 flex-1 text-left">
                  ...
                  <p className="mt-1 text-xs text-slate-600">We structure offers to our end customers based on the agreed parameters.</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative flex justify-center">
              <div className="relative flex w-full max-w-4xl flex-row-reverse items-center rounded-full bg-white px-10 py-6 shadow-[0_10px_30px_rgba(15,23,42,0.06)]">
                ...
                <div className="mr-6 flex-1 text-right">
                  ...
                  <p className="mt-1 text-xs text-slate-600">We configure routing and delegation so leased space is ready for service.</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative flex justify-center">
              <div className="relative flex w-full max-w-4xl items-center rounded-full bg-white px-10 py-6 shadow-[0_10px_30px_rgba(15,23,42,0.06)]">
                ...
                <div className="ml-6 flex-1 text-left">
                  <p className="text-sm font-semibold text-slate-900">Deferred</p>
                  <p className="mt-1 text-xs text-slate-600">You receive lease revenue on the agreed billing cycle as long as space is in use.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-b from-slate-900 to-slate-950 p-8">
              ...
              <div className="relative space-y-4">
                ...
                <p className="text-sm text-slate-200">
                  Share which ranges you want to lease to us, the regions involved, and preferred contract duration.
                </p>
            ...
            <form className="space-y-5 rounded-3xl bg-slate-900/80 p-8 shadow-xl">
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  placeholder="Share any details about your IPv4 ranges, regions, and preferred lease terms."
                />
              </div>
