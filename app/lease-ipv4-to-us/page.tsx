        ...
        <section className="mx-auto mt-32 max-w-6xl px-4 lg:px-0">
          <div className="text-center mb-20">
            ...
            <p className="mt-4 text-slate-600 text-lg max-w-2xl mx-auto font-medium">
              Turn your unused address space into a secure, recurring revenue stream.
            </p>
          </div>
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative rounded-2xl bg-white p-8 shadow-[0_4px_20px_-4px_rgba(15,23,42,0.05)] ring-1 ring-slate-900/5 transition-all duration-300 hover:shadow-[0_20px_40px_-4px_rgba(15,23,42,0.1)] hover:-translate-y-1">
                      ...
                      <p className="text-slate-600 leading-relaxed text-sm relative z-10 font-medium">
                        We discuss lease terms, regions, and usage policies that suit your goals.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="w-full md:w-1/2 md:pl-16 md:text-left">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-2xl bg-white p-8 shadow-[0_4px_20px_-4px_rgba(15,23,42,0.05)] ring-1 ring-slate-900/5 transition-all duration-300 hover:shadow-[0_20px_40px_-4px_rgba(15,23,42,0.1)] hover:-translate-y-1">
                      ...
                      <p className="text-slate-600 leading-relaxed text-sm relative z-10 font-medium">
                        We sign an NDA and a preliminary lease framework to protect both parties.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="w-full md:w-1/2 md:pr-16 md:text-right">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-2xl bg-white p-8 shadow-[0_4px_20px_-4px_rgba(15,23,42,0.05)] ring-1 ring-slate-900/5 transition-all duration-300 hover:shadow-[0_20px_40px_-4px_rgba(15,23,42,0.1)] hover:-translate-y-1">
                      ...
                      <p className="text-slate-600 leading-relaxed text-sm relative z-10 font-medium">
                        We structure offers to our end customers based on the agreed parameters.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="w-full md:w-1/2 md:pl-16 md:text-left">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-2xl bg-white p-8 shadow-[0_4px_20px_-4px_rgba(15,23,42,0.05)] ring-1 ring-slate-900/5 transition-all duration-300 hover:shadow-[0_20px_40px_-4px_rgba(15,23,42,0.1)] hover:-translate-y-1">
                      ...
                      <p className="text-slate-600 leading-relaxed text-sm relative z-10 font-medium">
                        We configure routing and delegation so leased space is ready for service.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="w-full md:w-1/2 md:pr-16 md:text-right">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-2xl bg-white p-8 shadow-[0_4px_20px_-4px_rgba(15,23,42,0.05)] ring-1 ring-slate-900/5 transition-all duration-300 hover:shadow-[0_20px_40px_-4px_rgba(15,23,42,0.1)] hover:-translate-y-1">
                      ...
                      <h3 className="text-xl font-bold text-slate-900 relative z-10 mb-2">Deferred</h3>
                      <p className="text-slate-600 leading-relaxed text-sm relative z-10 font-medium">
                        You receive lease revenue on the agreed billing cycle as long as space is in use.
                      </p>
                    </div>
                  </div>
                </div>
