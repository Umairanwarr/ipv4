...
export default function BuyRipeIPv4Page() {
  return (
      ...
      <main className="pb-20">
          ...
          {Array.from({ length: 9 }).map((_, idx) => (
            ...
            >
              <div className="mb-4 flex h-16 w-28 items-center justify-center rounded-2xl bg-slate-50">
                <span className="text-sm font-semibold tracking-wide text-slate-800">RIPE NCC</span>
              </div>
              <p className="text-[11px] text-slate-500">IPv4 address space in the RIPE region.</p>
        ...
        <section className="mx-auto mt-20 flex max-w-6xl flex-col gap-12 px-4 md:flex-row md:items-center lg:px-0">
              ...
              <div className="relative w-full max-w-md rounded-[40px] bg-white p-4 shadow-[0_24px_60px_rgba(15,23,42,0.18)]">
                <div className="overflow-hidden rounded-[32px] bg-slate-200">
                  <Image
                    ...
                    alt="Hand interacting with digital network visualization"
                    width={900}
                    height={600}
          ...
          <div className="flex-1 space-y-4">
            <h2 className="text-2xl font-semibold text-slate-900">Who is RIPE?</h2>
            <p className="text-sm leading-relaxed text-slate-600">
              RIPE and the RIPE NCC coordinate IP address resources and routing policy for Europe, the Middle East, and parts
              of Central Asia. The RIPE NCC acts as the Regional Internet Registry for this service region.
            </p>
            <p className="text-sm leading-relaxed text-slate-600">
              Any IPv4 transfer within this region must follow RIPE policies and be accurately reflected in registry
              records.
            </p>
          </div>
        </section>
        ...
        <section className="mx-auto mt-16 flex max-w-6xl flex-col gap-12 px-4 md:flex-row md:items-center lg:px-0">
          <div className="order-2 flex-1 space-y-4 md:order-1">
            <h2 className="text-2xl font-semibold text-slate-900">RIPE's Unique Approach to IPv4 Transfers</h2>
            <p className="text-sm leading-relaxed text-slate-600">
              RIPE transfer policy is community-driven and emphasizes clear documentation of holder changes, proper
              justification, and anti-abuse safeguards.
            </p>
            <p className="text-sm leading-relaxed text-slate-600">
              We convert those rules into a practical checklist and manage the communication with RIPE on your behalf so the
              process feels straightforward.
            </p>
          </div>
              ...
              <div className="relative w-full max-w-md rounded-[40px] bg-white p-4 shadow-[0_24px_60px_rgba(15,23,42,0.18)]">
                <div className="overflow-hidden rounded-[32px] bg-slate-200">
                  <Image
                    ...
                    alt="Team reviewing global connectivity map"
                    width={900}
                    height={600}
                    className="h-full w-full object-cover"
                  />
        ...
        <section className="mx-auto mt-16 flex max-w-6xl flex-col gap-12 px-4 md:flex-row md:items-center lg:px-0">
            ...
            <div className="relative flex justify-center md:justify-start">
              <div className="relative w-full max-w-md rounded-[40px] bg-white p-4 shadow-[0_24px_60px_rgba(15,23,42,0.18)]">
                <div className="overflow-hidden rounded-[32px] bg-slate-200">
                  <Image
                    src="https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=1400&q=80"
                    alt="Business stakeholders discussing network strategy"
                    width={900}
                    height={600}
                    className="h-full w-full object-cover"
                  />
          ...
          <div className="flex-1 space-y-4">
            <h2 className="text-2xl font-semibold text-slate-900">Why RIPE Works for Buyers and Sellers</h2>
            <p className="text-sm leading-relaxed text-slate-600">
              The RIPE region is highly interconnected, making it attractive for buyers who need reliable routing and
              peering options. Sellers benefit from strong demand and a transparent transfer framework.
            </p>
            <p className="text-sm leading-relaxed text-slate-600">
              We help both sides understand pricing, timelines, and documentation so deals move smoothly from agreement to
        ...
        <section className="mx-auto mt-16 flex max-w-6xl flex-col gap-12 px-4 md:flex-row md:items-center lg:px-0">
          <div className="order-2 flex-1 space-y-4 md:order-1">
            <h2 className="text-2xl font-semibold text-slate-900">The Role of Local Internet Registries (LIRs)</h2>
            <p className="text-sm leading-relaxed text-slate-600">
              Many organizations in the RIPE region operate as Local Internet Registries, handling address distribution to
              their own customers.
            </p>
            <p className="text-sm leading-relaxed text-slate-600">
              We work with your LIR or help you collaborate with trusted partners so that transfers and sponsorships
              correctly reflect your operational reality.
            </p>
          </div>
          <div className="order-1 flex-1 md:order-2">
            <div className="relative flex justify-center md:justify-end">
              <div className="relative w-full max-w-md rounded-[40px] bg-white p-4 shadow-[0_24px_60px_rgba(15,23,42,0.18)]">
                <div className="overflow-hidden rounded-[32px] bg-slate-200">
                  <Image
                    src="https://images.unsplash.com/photo-1520607162513-77705c0f0d4a?auto=format&fit=crop&w=1400&q=80"
                    alt="Group presentation in front of global map"
                    width={900}
                    height={600}
                    className="h-full w-full object-cover"
                  />
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-b from-slate-900 to-slate-950 p-8">
              ...
              <div className="relative space-y-4">
                ...
                <h2 className="text-2xl font-semibold">
                  Kindly fill the form below and our RIPE specialist will contact you.
                </h2>
                <p className="text-sm text-slate-200">
                  Tell us what you want to achieve in the RIPE region and we'll respond with specific options for buying or
                  selling IPv4 space.
                </p>
            ...
            <form className="space-y-5 rounded-3xl bg-slate-900/80 p-8 shadow-xl">
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  placeholder="Share any details about your RIPE requirements, timelines, and regions."
                />
              </div>
              <div className="space-y-3 text-xs text-slate-400">
                ...
                <p>
                  By submitting this form you agree that we may contact you about RIPE IPv4 services in accordance with our
