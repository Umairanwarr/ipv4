...
export default function BuyAfrinicIPv4Page() {
      ...
      <main className="pb-20">
        <section className="relative h-80 w-full overflow-hidden bg-slate-950">
          ...
          <div className="relative mx-auto flex h-full max-w-6xl items-center px-4 text-white lg:px-0">
            <h1 className="text-3xl font-semibold sm:text-4xl md:text-5xl">
              Buy and Sell AFRINIC IPv4 Addresses
            </h1>
          </div>
        </section>
        ...
        <section className="mx-auto mt-12 flex max-w-4xl flex-col gap-6 px-4 text-center md:flex-row md:items-stretch md:justify-center lg:px-0">
          <div className="flex-1 rounded-3xl bg-white p-8 shadow-[0_16px_40px_rgba(15,23,42,0.12)]">
            <div className="mx-auto mb-6 flex h-20 w-32 items-center justify-center rounded-2xl bg-slate-50">
              <span className="text-sm font-semibold tracking-wide text-slate-800">AFRINIC</span>
            </div>
            <h2 className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">Buy IPv4</h2>
            <p className="mt-3 text-xs leading-relaxed text-slate-600">
              Secure clean AFRINIC IPv4 space for your operations with guided brokerage and transfer support.
            </p>
            <div className="mt-6">
              <a
                href="/buy-ipv4"
          ...
          <div className="flex-1 rounded-3xl bg-white p-8 shadow-[0_16px_40px_rgba(15,23,42,0.12)]">
            ...
            <p className="mt-3 text-xs leading-relaxed text-slate-600">
              Monetize unused AFRINIC address space through a compliant and transparent sales process.
            </p>
            <div className="mt-6">
              <a
                href="/sell-ipv4"
        ...
        <section className="mx-auto mt-20 flex max-w-6xl flex-col gap-12 px-4 md:flex-row md:items-center lg:px-0">
          ...
          <div className="flex-1 space-y-4">
            <h2 className="text-2xl font-semibold text-slate-900">What is AFRINIC?</h2>
            <p className="text-sm leading-relaxed text-slate-600">
              AFRINIC is the Regional Internet Registry responsible for allocating and managing IP address resources across
              Africa and parts of the Indian Ocean region. Any IPv4 transfers in this region must comply with AFRINIC
              policies and procedures.
            </p>
            <p className="text-sm leading-relaxed text-slate-600">
              We help buyers and sellers navigate those requirements so that every transaction is properly documented and
        ...
        <section className="mx-auto mt-16 flex max-w-6xl flex-col gap-12 px-4 md:flex-row md:items-center lg:px-0">
          <div className="order-2 flex-1 md:order-1 space-y-4">
            <h2 className="text-2xl font-semibold text-slate-900">Policy Development and Transfers</h2>
            <p className="text-sm leading-relaxed text-slate-600">
              AFRINIC policy is shaped by the local community and can evolve over time. We stay close to policy
              developments so you understand how current rules impact transfer eligibility and timelines.
            </p>
            <p className="text-sm leading-relaxed text-slate-600">
              Our team prepares the necessary documentation, justifications, and transfer requests, reducing the amount of
              back-and-forth needed with registry staff.
            </p>
          </div>
        ...
        <section className="mx-auto mt-16 flex max-w-6xl flex-col gap-12 px-4 md:flex-row md:items-center lg:px-0">
          ...
          <div className="flex-1 space-y-4">
            <h2 className="text-2xl font-semibold text-slate-900">Governance and Safeguards</h2>
            <p className="text-sm leading-relaxed text-slate-600">
              Governance in the AFRINIC region includes safeguards around resource registration, due diligence, and
              anti-abuse. We align our processes with those safeguards so your transfers meet both the letter and spirit of
              the rules.
            </p>
            <p className="text-sm leading-relaxed text-slate-600">
              That means clear contracts, verified counterparties, and transparent communication throughout the deal.
            </p>
          </div>
        </section>
        ...
        <section className="mx-auto mt-16 flex max-w-6xl flex-col gap-12 px-4 md:flex-row md:items-center lg:px-0">
          <div className="order-2 flex-1 md:order-1 space-y-4">
            <h2 className="text-2xl font-semibold text-slate-900">Navigating IPv4 Exhaustion</h2>
            <p className="text-sm leading-relaxed text-slate-600">
              With AFRINIC's free pool exhausted, transfers are now the primary path to new IPv4 capacity. We help you
              understand what is realistically available and how pricing trends are evolving.
            </p>
            <p className="text-sm leading-relaxed text-slate-600">
              Whether you are acquiring space for growth or divesting unused ranges, we structure deals that work within
          ...
          <div className="mx-auto grid max-w-6xl gap-10 px-4 md:grid-cols-[minmax(0,1.05fr)_minmax(0,1.1fr)] lg:px-0">
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-b from-slate-900 to-slate-950 p-8">
              ...
              <div className="relative space-y-4">
                ...
                <h2 className="text-2xl font-semibold">
                  Kindly fill the form below and our AFRINIC specialist will contact you.
                </h2>
                <p className="text-sm text-slate-200">
                  Share what you are looking to do in the AFRINIC region—buying, selling, or both—and we'll respond with
            ...
            <form onSubmit={onSubmit} className="space-y-5 rounded-3xl bg-slate-900/80 p-8 shadow-xl">
              ...
              <div className="space-y-3 text-xs text-slate-400">
                ...
                <p>
                  By submitting this form you agree that we may contact you about AFRINIC IPv4 services in accordance with our
