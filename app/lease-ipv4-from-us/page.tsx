            ...
            <div className="relative flex justify-center">
              <div className="relative flex w-full max-w-4xl items-center rounded-full bg-white px-10 py-6 shadow-[0_10px_30px_rgba(15,23,42,0.06)]">
                ...
                <div className="ml-6 flex-1 text-left">
                  <p className="text-sm font-semibold text-slate-900">Inquiry</p>
                  <p className="mt-1 text-xs text-slate-600">Provide us with your customer demand, region, and lease period requirements.</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative flex justify-center">
              <div className="relative flex w-full max-w-4xl flex-row-reverse items-center rounded-full bg-white px-10 py-6 shadow-[0_10px_30px_rgba(15,23,42,0.06)]">
                ...
                <div className="mr-6 flex-1 text-right">
                  ...
                  <p className="mt-1 text-xs text-slate-600">We sign an NDA and a lease framework so information stays protected.</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative flex justify-center">
              <div className="relative flex w-full max-w-4xl items-center rounded-full bg-white px-10 py-6 shadow-[0_10px_30px_rgba(15,23,42,0.06)]">
                ...
                <div className="ml-6 flex-1 text-left">
                  ...
                  <p className="mt-1 text-xs text-slate-600">We select suitable ranges and prepare LOA / routing details with your team.</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative flex justify-center">
              <div className="relative flex w-full max-w-4xl flex-row-reverse items-center rounded-full bg-white px-10 py-6 shadow-[0_10px_30px_rgba(15,23,42,0.06)]">
                ...
                <div className="mr-6 flex-1 text-right">
                  ...
                  <p className="mt-1 text-xs text-slate-600">Once the lease terms are confirmed, you make the initial lease payment.</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative flex justify-center">
              <div className="relative flex w-full max-w-4xl items-center rounded-full bg-white px-10 py-6 shadow-[0_10px_30px_rgba(15,23,42,0.06)]">
                ...
                <div className="ml-6 flex-1 text-left">
                  ...
                  <p className="mt-1 text-xs text-slate-600">We delegate the lease to your network and you start announcing the space.</p>
                </div>
              </div>
            </div>
          </div>
